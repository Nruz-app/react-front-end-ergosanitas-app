...
import { routesED } from './routesED';
import { Loading } from './Loading';

export const NavigationED = () => {
            ...
            <Routes>
             {
                ...
                <Route path='/*' element={ <Navigate to ={ routesED[0].to }  replace /> } />   
            </Routes>            
